...
(function (factory) {
  ...
  $.fn.serializeJSON = function (options) {
    ...
    $.each(serializedArray, function (_i, obj) {
      ...
      var typedValue = f.applyTypeFunc(
        obj.name,
        obj.value,
        type,
        obj.el,
      ...
      if (
        !typedValue &&
        f.shouldSkipFalsy(obj.name, nameSansType, type, obj.el, opts)
      ) {
  ...
  $.serializeJSON = {
        ...
        .filter(function () {
          ...
          return (
            ...
            (this.checked ||
              ...
              f.getCheckboxUncheckedValue($el, opts) != null)
    ...
    shouldSkipFalsy: function (name, nameSansType, type, el, opts) {
      ...
      if (
        optForFields &&
        (optForFields.indexOf(nameSansType) !== -1 ||
