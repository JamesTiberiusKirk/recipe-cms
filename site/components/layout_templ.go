...
func navBarTempl(loggedIn bool, user string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"w-full md:max-w-3xl mx-auto\"><header class=\"w-full\"><div class=\"flex p-2 justify-evenly\"><a class=\"link\" href=\"/recipes\">Recipes</a> ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if loggedIn {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<a class=\"link\" href=\"/recipe/new/edit\">Add Recipe</a> <a class=\"link\" href=\"/auth/logout\">Logout ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `site/components/layout.templ`, Line: 35, Col: 54}
			}
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<a class=\"link\" href=\"/auth/login\">Login</a>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
...
func onLoad() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_onLoad_f21f`,
		Function: `function __templ_onLoad_f21f(){// htmx.logAll();
	...
	*/
	...
	htmx.on("toast_info", toaster)
		...
		Call:       templ.SafeScript(`__templ_onLoad_f21f`),
		CallInline: templ.SafeScriptInline(`__templ_onLoad_f21f`),
	}
}
